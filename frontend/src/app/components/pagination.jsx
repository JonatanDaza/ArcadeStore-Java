...
export default function Pagination({
  ...
  return (
    <div className="flex flex-col md:flex-row justify-between items-center text-white gap-2">
      ...
      <div className="flex gap-1">
        <button
          ...
          className="bg-[#23272e] h-8 hover:bg-gray-300 text-gray-300 hover:text-gray-900 border-[0.1px] hover:border-gray-400 font-bold py-2 px-1 rounded-xl shadow-lg transition disabled:opacity-40 disabled:cursor-not-allowed mx-1 flex items-center justify-center"
        ...
        {pageNumbers.map(i => (
          <button
            key={i}
            onClick={() => gotoPage(i)}
            className={`mx-1 h-8 px-3 py-2 rounded-xl font-bold shadow-lg border-[0.1px] transition flex items-center justify-center ${
              pageIndex === i
