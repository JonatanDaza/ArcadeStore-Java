...
export default function SidebarPerfil({
  ...
  return (
    <aside className="w-70 bg-black border-r border-[#333] p-8 flex flex-col">
      ...
      <nav className="flex flex-col gap-4 flex-1">
        {sidebarOptions.map((option) => (
          <button
            ...
            className={`text-left px-4 py-3 rounded-lg transition-colors border-[0.1] border-gray-700 ${
              selected === option.key
